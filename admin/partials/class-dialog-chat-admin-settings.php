 ...
 *
 * The class defines the admin settings for the plugin.
 * 
 * php version 8.2.0
 * 
...
class Dialog_Chat_Admin_Settings
{
    ...
    /**
     * Fron-end view of the Whatsapp chat.
     *
     * @since  1.0.0
     * @return NULL
     */
    public function dcWhatsappSettigngsPageRender()
    {
        ...
        <?php _e('Design Settings', 'dialog-chat'); ?>
           ...
           <?php
            wp_nonce_field(
                'dc_text_settings_nonce', 
                'dc_text_settings_nonce_field'
            );
            submit_button(
                'Save Text Settings', 
                'primary', 
          ...
          <?php
            wp_nonce_field(
                'dc_design_settings_nonce', 
                'dc_design_settings_nonce_field'
            );
